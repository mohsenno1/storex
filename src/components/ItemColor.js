...
export default class ItemColor extends Component {
    render() {
        const { size, active, color } = this.props;
                ...
                <G transform="translate(-32.000000, -811.000000)">
                    <G transform="translate(29.000000, 749.000000)">
                        <G transform="translate(0.000000, 64.000000)">
                            <Polygon fill={active ? '#F3B453' : null} stroke={active ? '#F3B453' : "#CCCCCC"} stroke-width={size / 8} points="35 0 65.3108891 17.5 65.3108891 52.5 35 70 4.68911087 52.5 4.68911087 17.5" />
